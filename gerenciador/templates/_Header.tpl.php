...
<html lang="en">
	<head>
		...
		<meta name="description" content="gerenciador" />
			...
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="./">gerenciador</a>
						<div class="nav-collapse collapse">
							<ul class="nav">
								...
								<li <?php if ($this->nav=='listaemails') { echo 'class="active"'; } ?>><a href="./listaemails">ListaEmails</a></li>
							</ul>
							<ul class="nav">
								<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">More <b class="caret"></b></a>
								<ul class="dropdown-menu">
								<li <?php if ($this->nav=='tipoeventos') { echo 'class="active"'; } ?>><a href="./tipoeventos">TipoEventos</a></li>
