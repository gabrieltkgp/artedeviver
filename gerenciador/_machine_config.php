...
GlobalConfig::$CONNECTION_SETTING->DBName = "u210765844_1";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "asd";
...
/** the root url of the application with trailing slash, for example http://localhost/gerenciador/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'artedeviver/artedeviver/gerenciador/';
