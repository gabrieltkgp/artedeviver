...
var page = {
	...
	showDetailDialog: function(m) {
		...
		$('#eventoDetailDialog').modal({ show: true });
	...
	renderModelView: function(showDeleteButton)	{
		...
		if (showDeleteButton) {
			...
			$('#cancelDeleteEventoButton').click(function(e) {
				e.preventDefault();
				$('#confirmDeleteEventoContainer').hide('fast');
			});
	...
	updateModel: function() {
		...
		page.evento.save({
			...
			'data': $('input#data').val()+' '+$('input#data-time').val(),
			'idCidade': $('input#idCidade').val(),
			'privado': $('input#privado').val(),
			'link': $('input#link').val(),
			'map': $('input#map').val(),
			'idTipoEvento': $('input#idTipoEvento').val()
		}, {
			wait: true,
			success: function(){
