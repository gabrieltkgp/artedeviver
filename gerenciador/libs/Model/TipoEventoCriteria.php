...
require_once("DAO/TipoEventoCriteriaDAO.php");

/**
 * The TipoEventoCriteria class extends TipoEventoDAOCriteria and is used
 ...
 * @version 1.0
 */
class TipoEventoCriteria extends TipoEventoCriteriaDAO
{
