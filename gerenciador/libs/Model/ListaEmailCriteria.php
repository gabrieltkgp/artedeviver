...
require_once("DAO/ListaEmailCriteriaDAO.php");

/**
 * The ListaEmailCriteria class extends ListaEmailDAOCriteria and is used
 ...
 * @version 1.0
 */
class ListaEmailCriteria extends ListaEmailCriteriaDAO
{
