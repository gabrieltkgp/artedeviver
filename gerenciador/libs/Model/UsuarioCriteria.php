...
require_once("DAO/UsuarioCriteriaDAO.php");

/**
 * The UsuarioCriteria class extends UsuarioDAOCriteria and is used
 ...
 * @version 1.0
 */
class UsuarioCriteria extends UsuarioCriteriaDAO
{
